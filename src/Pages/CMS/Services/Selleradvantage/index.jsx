    ...
    <div className="Selleradvantage_main">
      <div className="Selleradvantage_img_section">
        <div className="Selleradvantage_business_section">
          <h4 className="Selleradvantage_business_Heading">
            Enhance Bussiness
          </h4>
          <p className="Selleradvantage_business_tag">
            Grow your Revenues & Customer Base
          </p>
        </div>
        ...
        <h3 className="Selleradvantage_Heading">
          Seller <br></br>
          Advantages
        </h3>
