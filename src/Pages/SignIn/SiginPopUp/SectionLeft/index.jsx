...
import { Clear, FemaleSharp, FlashOnOutlined } from "@mui/icons-material";
      ...
      >
        <div className={forgotpassword}>
          <div className={forgotpassword__title}>
            Forgot Password ?
            <Clear className={forgotpassword__clearbtn} onClick={() => setpassopen(false)} />
          </div>
          <div className={forgotpassword__container}>
            <div className={forgotpassword__content}>
              <div className={forgotpassword__email}>
                <p className={forgotpassword__para}>Enter your E-mail address to receive a link to reset Password.</p>
                <TextField
                    id="email_address"
                    name="email_address"
                    ...
                    variant="outlined"
                  />
                <button onClick={() => setpassopen(false)} className={forgotpassword__submit}>Submit</button>
              </div>
          ...
          <div className={sections}>
            <div className={section_left}>
              ...
              <div className={input_fields}>
                ...
                <p className={forgot_password} onClick={forgotpass}>Forgot Password?</p>
              </div>
            </div>
