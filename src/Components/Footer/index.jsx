        ...
        <div className="footer_container_right">
          <div className="Footer_box_col_234">
            ...
            <ul className="Footer_col_list">
              <Link to={`/${customnostore ? customnostore : geo?.country_name}/aboutus`} className="to_CMS">
                <li>About Us</li>
              </Link>
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/termsofuse`} className="to_CMS">
                <li>Terms Of Use</li>
              </Link>
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/privacypolicy`} className="to_CMS">
                <li>Privacy Policy</li>
              </Link>
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/rrpolicy`} className="to_CMS">
                <li>Refund Policy</li>
              </Link>
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/productlistingpolicy`} className="to_CMS">
                <li> Product Listing Policy</li>
              </Link>
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/contactus`} className="to_CMS">
                <li>Contact Us</li>
              </Link>
            </ul>
          </div>
          <div className="Footer_box_col_234">
            ...
            <ul className="Footer_col_list">
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/training`} className="to_CMS">
                <li>Training</li>
              </Link>
              <Link to={`/${customnostore ? customnostore : geo?.country_name}/seller_advantage`} className="to_CMS">
                <li>Seller Advantage</li>
              </Link>
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/buyer_advantage`} className="to_CMS">
                <li>Buyer Advantage</li>
              </Link>
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/career`} className="to_CMS">
                <li>Career</li>
              </Link>
              <Link to={`/${customnostore ? customnostore : geo?.country_name}`} className="to_CMS">
                <li>How Its Works</li>
              </Link>
            </ul>
          </div>
          <div className="Footer_box_col_234">
            ...
            <ul className="Footer_col_list">
              <Link to={`/${customnostore ? customnostore : geo?.country_name}/legal`} className="to_CMS">
                <li>Legal</li>
              </Link>
              <li
              ...
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/gdpr`} className="to_CMS">
                <li>GDPR</li>
              </Link>
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/Faqs`} className="to_CMS">
                <li>FAQs</li>
              </Link>
              <Link to= {`/${customnostore ? customnostore : geo?.country_name}/blogsmain`} className="to_CMS">
                <li>Blogs</li>
              </Link>
            </ul>
          </div>
