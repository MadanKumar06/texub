    ...
    <div className="myAccount_popup_header_dropdown">
      ...
      >
        ...
        <MenuItem onClick={() => handleClose()}>
          <Link to={`/${customnostore ? customnostore : geo?.country_name}/kycdetails`}>
           <svg width="31" height="27" viewBox="0 0 31 27" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M16 7H2C0.895431 7 0 7.89543 0 9V25C0 26.1046 0.895431 27 2 27H25C26.1046 27 27 26.1046 27 25V18H26V25C26 25.5523 25.5523 26 25 26H2C1.44772 26 1 25.5523 1 25V9C1 8.44772 1.44772 8 2 8H16V7Z" fill="black" />
              <line x1="16.5" y1="19.5" x2="20.5" y2="19.5" stroke="black" stroke-linecap="round" />
              <line x1="16.5" y1="22.5" x2="23.5" y2="22.5" stroke="black" stroke-linecap="round" />
            </svg>
            KYC Details
          </Link>
        </MenuItem>
        ...
        <MenuItem onClick={() => SignOut()}>
          <svg width="35.467" height="31.107" viewBox="0 0 158 152" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M20 5H72.1201C80.4101 5 87.1201 11.7157 87.1201 20V45.4848H92.1201V20C92.1201 8.9543 83.1701 0 72.1201 0H20C8.95 0 0 8.9543 0 20V132C0 143.046 8.95 152 20 152H72.1201C83.1701 152 92.1201 143.046 92.1201 132V106.515H87.1201V132C87.1201 140.284 80.4101 147 72.1201 147H20C11.72 147 5 140.284 5 132V20C5 11.7157 11.72 5 20 5Z" fill="black" />
            <path d="M156.65 77.7678C157.62 76.7915 157.62 75.2085 156.65 74.2322L140.74 58.3223C139.76 57.346 138.18 57.346 137.2 58.3223C136.22 59.2986 136.22 60.8816 137.2 61.8579L151.34 76L137.2 90.142C136.22 91.118 136.22 92.701 137.2 93.678C138.18 94.654 139.76 94.654 140.74 93.678L156.65 77.7678ZM56.4199 78.5H154.88V73.5H56.4199V78.5Z" fill="black" />
          </svg>
          Logout
        </MenuItem>
      </Menu>
