    ...
    <Box sx={{ width: "100%" }} className={classes.main_boxt_conatainer}>
      ...
      <TabPanel value={value} index={0} className={classes.sub_tab_conatainer}>
        ...
        <Link
          ...
          to={`/${customstore ? customstore : geo?.country_name}`}
          onClick={() => handleSideBarClose("left", false)}
        >
          <ListItem button>
      ...
      <TabPanel value={value} index={1} className={classes.sub_tab_conatainer}>
        ...
        <List onClick={() => handleSideBarClose("left", false)}>
          <Link className={classes.link_in_tab} to={`/${customstore ? customstore : geo?.country_name}/aboutus`}>
            <ListItem button>
              <ListItemText primary={"About Us"} />
            </ListItem>
          </Link>
          <Link className={classes.link_in_tab} to={`/${customstore ? customstore : geo?.country_name}/products`}>
            <ListItem button>
              <ListItemText primary={"Products"} />
            </ListItem>
          </Link>
          <Link className={classes.link_in_tab} to={`/${customstore ? customstore : geo?.country_name}/Sellontexhub`}>
            <ListItem button>
              <ListItemText primary={"Sell On TEXUB"} />
            </ListItem>
          </Link>
          <Link className={classes.link_in_tab} to={`/${customstore ? customstore : geo?.country_name}/Buyontexhub`}>
            <ListItem button>
              <ListItemText primary={"Buy On TEXUB"} />
            </ListItem>
          </Link>
          {/* <Link className={classes.link_in_tab} to={`/${customstore ? customstore : geo?.country_name}`}>
            <ListItem button>
              <ListItemText primary={"FAQ"} />
            </ListItem>
          </Link> */}

          <Link className={classes.link_in_tab} to={`/${customstore ? customstore : geo?.country_name}/Contactus`}>
            <ListItem button>
