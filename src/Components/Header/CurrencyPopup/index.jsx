    ...
    const fetchCurrencyDropDownData = () => {
      ...
      axios
        ...
        .then((res) => {
          ...
          if(str.split('/')[2] === 'buyerdashboard' || str.split('/')[2] === 'sellerdashboard' || str.split('/')[2] === "checkout" || str.split('/')[2] === 'register' || str.split('/')[2] === 'resetpassword' || str.split('/')[2] === 'blogsdetails' || str.split('/')[2] === 'sellerprofile' || str.split('/')[2] === 'thankyou' && storedata?.code.toLowerCase() === str.split('/')[1].toLowerCase()) {
