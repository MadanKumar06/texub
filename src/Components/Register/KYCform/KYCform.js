...
// import { AfterGratitude } from '../AfterGratitude/AfterGratitude'
import './KYCform.css'



export const KYCform = ({isKYC}) => {
    ...
    // if (isAfterKYC){
    //     return <Redirect to='/AfterGratitude'/>
    // }
            ...
            <div className='KYCform_body'>
                <div className='KYCform_Bank_Docs'>
                    <div className='KYCform_Bank_Docs_block'>
                        ...
                        <div className='KYCform_Hidden_blocks'>
                                    ...
                                    <form className='KYCform_Licence_Block_form'>
                                        ...
                                        <div className='KYCform_licence'>
                                            <div className='KYCform_licence_file_heading'>
                                                <label className='KYCform_Licence_attach_label'>Attach License</label>
                            ...
                            {isTaxCertificate?
                                <div className='KYCform_Tax_Block'>
                                    ...
                                    <div className='KYCform_licence'>
                                        <div className='KYCform_licence_file_heading'>
                                            <label className='KYCform_Licence_attach_label'>Attach Licence</label>
                                            <p className='KYCform_Licence_format'>(sopported format:.jpg/.png/.pdf)</p>
                                        </div>
                                        <div>
                                            <input className='KYCform_Lice_inputfields' type="file"
                        ...
                        {/* <button className='KYCform_btn'>Passport</button> */}
                    </div>
                ...
                <div className='KYCform_office_categories'>
                    ...
                    <div className='KYCform_Categories_blocks'>
                        ...
                        <div className='KYCform_Categories'>
                            ...
                            <div>
                                <Link to ='/Submit'>
                                <button className='KYCform_submit' onClick={After_KYC_gratitude}
                                    type="button">Submit</button>
                                </Link>
                                    
                                    {/* <Redirect to={AfterGratitude ? "/wallet/portfolio" : "/wallet/login"}/> */}
                                     {/* {isAfterKYC && <AfterGratitude/>}  */}
